...
# Update avatar
request("http://45.195.250.77:3000/api/users/me", method="PATCH", data={"avatar": "https://example.com/test_avatar.png"}, headers=headers)

# GET report
status, res = request("http://45.195.250.77:3000/api/users/me/report", method="GET", headers=headers)
print("Report response keys:", res["data"])
