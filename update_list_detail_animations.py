with open("app/src/main/java/com/example/ui/screens/ListDetailScreen.kt", "r") as f:
    content = f.read()
...
with open("app/src/main/java/com/example/ui/screens/ListDetailScreen.kt", "w") as f:
    f.write(content)
