...
content = content.replace("import com.example.ui.screens.AgendaItemData", import_str + "\nimport com.example.ui.screens.AgendaItemData")

old_auth = """    fun authorizeAndFetch(activity: Activity) {
...
new_auth = """    fun authorizeAndFetch(activity: Activity) {
        if (currentAccessToken != null) {
            fetchEvents(currentAccessToken!!)
            return
        }
